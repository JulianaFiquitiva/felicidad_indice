...
# =================================================================
    ...
    items_escala = [
        ...
        (24, "CP", "— (no disponible en el material revisado)", "—", "—"),
        (25, "PV", "— (no disponible en el material revisado)", "—", "—"),
    ...
    with st.expander("Ver la tabla completa de los 29 ítems"):
        ...
        st.caption(
            "Los ítems 24 y 25 no estaban incluidos en el material "
            "revisado — se dejan marcados, no se completan con un valor "
            "supuesto. Tras la inversión, un puntaje más alto en "
            "cualquier ítem refleja mayor bienestar subjetivo; todos los "
            "análisis posteriores (TCT, IRT) operan sobre los datos ya "
            "invertidos."
        )
